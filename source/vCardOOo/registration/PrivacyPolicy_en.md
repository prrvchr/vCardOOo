...
Use of the `Supplier` services via `OAuth2OOo` and/or `vCardOOo` may subject you to the data protection Policy of `Supplier`. It is the responsibility of the `User` to review this Policy from the `Supplier` website.
